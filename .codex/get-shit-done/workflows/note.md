...
- **Global scope**: `C:/Users/Pavel/Documents/GitHub/timesfm_fin/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Pavel/Documents/GitHub/timesfm_fin/.codex/notes/`)
...
2. Glob `C:/Users/Pavel/Documents/GitHub/timesfm_fin/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Pavel/Documents/GitHub/timesfm_fin/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Pavel/Documents/GitHub/timesfm_fin/.codex/notes/` — works in any directory
