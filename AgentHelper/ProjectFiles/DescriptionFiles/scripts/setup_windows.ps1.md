...
The script uses a small `Invoke-CheckedCommand` wrapper so failed subprocesses stop the setup immediately. It does not run model code itself; its side effects are environment creation and package installation under the repo root.
